...
namespace NoFences.Win32
{
    public class WindowUtil
    {
        ...
        // Define o estilo das bordas do dock
        ...
        //chamada de função, ele retornará a região arredondada da região fornecida
        public static System.Drawing.Region GetRoundedRegion(int controlWidth, int controlHeight)
        {
            return System.Drawing.Region.FromHrgn(CreateRoundRectRgn(5, 5, controlWidth - 5, controlHeight - 5, 12, 12));
        }
